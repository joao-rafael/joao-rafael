...
### 🚀 About Me  
- 🔧 **What I do:**  
   Front-End (Web and mobile) development with **Stencil**, **Angular**, **React**, **TypeScript**, **Flutter**, and **Node.js**.  

- 🧠 **Passionate about:**  
   Human Factors in Computing Systems and creating seamless user experiences.  

### 🛠️ Tech Stack  
- **Web:** HTML, CSS, JavaScript, **TypeScript**, **Angular**, **React**, **Stencil**, **Web Components**
